...
import com.example.android.background.sync.WaterReminderIntentServi;
...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
     ...
     Intent increamentwatercount=new Intent(this,WaterReminderIntentServi.class);
        increamentwatercount.setAction("increament_water_Count");
        startService(increamentwatercount);
